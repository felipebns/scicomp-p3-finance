...
class ModelSelector:
    ...
    def select(self, algorithms: list[Algorithm], train_df: pd.DataFrame, 
        ...
        with ProcessPoolExecutor(max_workers=self.max_workers) as executor:
            ...
            for future in futures:
                try:
                    algo_name, fold_ics, mean_ic, std_ic, score, elapsed = future.result()
                    ...
                    self._print_wfv_results(algo_name, fold_ics, mean_ic, std_ic, score, elapsed)
    ...
    def _evaluate_algorithm(algorithm, train_df: pd.DataFrame, 
        ...
        wfv_df, predictions, fold_ics, mean_ic, std_ic = validator.validate(
        ...
        return (algo_copy.name(), fold_ics, mean_ic, std_ic, score, elapsed)
