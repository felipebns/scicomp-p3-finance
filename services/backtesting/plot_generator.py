...
class PlotGenerator:
    ...
    def plot_all(self, backtest_results: Dict, test_df: pd.DataFrame, output_dir: str) -> None:
        ...
        self._plot_stock_selection_summary(backtest_results, test_df, output_dir)
    ...
    def _plot_stock_selection_summary(self, backtest_results: Dict, test_df: pd.DataFrame, output_dir: str) -> None:
